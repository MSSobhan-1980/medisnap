...
export const createRPCFunctions = async () => {
  try {
    ...
    try {
      await ((supabase as any).rpc('create_get_user_roles_function', {}) as unknown as Promise<any>);
    } catch (error) {
    ...
    try {
      await ((supabase as any).rpc('create_get_caregiver_dependents_function', {}) as unknown as Promise<any>);
    } catch (error) {
    ...
    try {
      await ((supabase as any).rpc('create_get_user_meal_detections_function', {}) as unknown as Promise<any>);
    } catch (error) {
    ...
    try {
      await ((supabase as any).rpc('create_delete_user_meal_detections_function', {}) as unknown as Promise<any>);
    } catch (error) {
    ...
    try {
      await ((supabase as any).rpc('create_insert_user_consents_function', {}) as unknown as Promise<any>);
    } catch (error) {
